  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-20 right-10 w-96 h-96 bg-vibrant/10 rounded-full blur-3xl animate-float" style={{animationDelay: '1s'}}></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-purple/10 rounded-full blur-3xl animate-float" style={{animationDelay: '2s'}}></div>
      </div>
      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        <div className="animate-fade-in">
          ...
          <p className="text-lg md:text-xl mb-8 text-gray-400 max-w-2xl mx-auto">
            Blending creativity with data to build impactful digital experiences.
            Currently pursuing my degree at JLU Bhopal, passionate about technology and innovation.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button 
              variant="outline" 
              size="lg" 
              className="border-vibrant text-vibrant hover:bg-vibrant hover:text-black px-8 py-3"
            >
